...
final class DefaultFollowRelationUseCaseTests: XCTestCase {
    var useCase: DefaultFollowRelationUseCase!
    ...
    override func setUp() {
        ...
        useCase = DefaultFollowRelationUseCase(service: mockService, authService: mockAuthService)
    }
